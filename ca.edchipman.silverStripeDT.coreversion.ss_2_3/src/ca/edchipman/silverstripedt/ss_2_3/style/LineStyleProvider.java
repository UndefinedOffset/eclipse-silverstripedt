package ca.edchipman.silverstripedt.ss_2_3.style;
...
public class LineStyleProvider extends SilverStripeVersionStyleProvider {
    ...
    public void loadVersionColors() {
        //Remove cache block support, since it's not supported in 2.3
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_CACHEBLOCK_OPEN);
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_CACHEBLOCK_CONTENT);
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_END_CACHEBLOCK);
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_UNCACHED_OPEN);
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_UNCACHED_CONTENT);
        this.lineStyleProvider.removeTextAttribute(IStyleConstantsSS.SS_END_UNCACHED);
        

        //Remove loop and with block as well as i18n tag support, since it's not supported in 2.3
