...
%public
%class SSTokenizer
%implements BlockTokenizer, DOMRegionContext, SilverStripeRegionContext
...
%state ST_SS
%state ST_SS_COMMENT
%state ST_SS_COMMENT_END
%state ST_SS_CONDITIONAL_CONTENT
%state ST_SS_CONDITIONAL_END
%state ST_SS_REQUIREMENT_CONTENT
...
// [90] SSComment ::= '<%--' ((Char - '-') | ('-' (Char - '-')))* '--%>'
SSCommentStart = (<\%\-\-)
SSCommentEnd   = (\-\-\%>)
SSComment = ({SSCommentStart}.*{SSCommentEnd})

// [91] If ::= '<% (else_)?if ' ((Char - '-') | ('-' (Char - '-')))* ' %>'
SSIfConditionStart = ((else_)?if)
SSIfCondition = ({SSIfConditionStart}.*%>)
...
SSVariable3 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)\u007D)
SSVariable4 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+)\u007D)
SSVariable5 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+)\u007D)
SSVariable6 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\u007D)
SSVariable7 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+)\u007D)
SSVariable8 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\u007D)
SSVariable9 = (\u007B\$([A-Za-z_][A-Za-z0-9_]*)\u007D)
SSVariable10 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\(([^),]+)\)([^A-Za-z0-9]))
SSVariable11 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\(([^),]+), *([^),]+)\)([^A-Za-z0-9]))
SSVariable12 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+)([^A-Za-z0-9]))
SSVariable13 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)\.([A-Za-z0-9_]+)([^A-Za-z0-9]))
SSVariable14 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)([^A-Za-z0-9]))
SSVariable15 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+)([^A-Za-z0-9]))
SSVariable16 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+)([^A-Za-z0-9]))
SSVariable17 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)([^A-Za-z0-9]))
SSVariable18 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+))
SSVariable19 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+))
SSVariable20 = (\$([A-Za-z_][A-Za-z0-9_]*))
SSVariable21 = (\$([A-Za-z_][A-Za-z0-9_]*))
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_XML_DECLARATION, ST_DHTML_ATTRIBUTE_VALUE, ST_DHTML_EQUALS> {SSCommentStart} {
    if(SSTokenizer.debugTokenizer)
...
<ST_SS_COMMENT_END> {SSCommentEnd} {
    if(SSTokenizer.debugTokenizer)
...
//Variables
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_XML_DECLARATION, ST_CDATA_TEXT> ({SSVariable1} | {SSVariable2} | {SSVariable3} | {SSVariable4} | {SSVariable5} | {SSVariable6} | {SSVariable7} | {SSVariable8} | {SSVariable9} | {SSVariable10} | {SSVariable11} | {SSVariable12} | {SSVariable13} | {SSVariable14} | {SSVariable15} | {SSVariable16} | {SSVariable17} | {SSVariable18} | {SSVariable19} | {SSVariable20} | {SSVariable21}) {
    if(SSTokenizer.debugTokenizer)
...
// SilverStripe Tags
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_XML_DECLARATION> {SSstart} {
    if(SSTokenizer.debugTokenizer)
...
<YYINITIAL, ST_XML_TAG_NAME, ST_XML_EQUALS, ST_XML_ATTRIBUTE_NAME, ST_XML_ATTRIBUTE_VALUE, ST_XML_DECLARATION> {SSend} {
    if(SSTokenizer.debugTokenizer)
...
<ST_SS> end_cacheblock|end_cached {
    if(SSTokenizer.debugTokenizer)
