...
SSVariable10 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\(([^),]+)\))
SSVariable11 = (\$([A-Za-z_][A-Za-z0-9_]*)\.([A-Za-z0-9_]+)\(([^),]+), *([^),]+)\))
SSVariable12 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+))
SSVariable13 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)\.([A-Za-z0-9_]+))
SSVariable14 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+), *([^),]+)\)([^A-Za-z0-9]))
SSVariable15 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+)\.([A-Za-z0-9_]+))
SSVariable16 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\)\.([A-Za-z0-9_]+))
SSVariable17 = (\$([A-Za-z_][A-Za-z0-9_]*)\(([^),]+)\))
