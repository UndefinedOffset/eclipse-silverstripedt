package ca.edchipman.silverstripedt.ss_4.language;
...
public class DefaultLanguageModelProvider implements ISilverStripeLanguageModelProvider {
    ...
    private static boolean _packedLangUpToDate = true;
    ...
    public String getTemplateContext() {
        return NewSilverStripeTemplatesWizardPage.NEW_SS_40_TEMPLATE_CONTEXTTYPE;
    }
