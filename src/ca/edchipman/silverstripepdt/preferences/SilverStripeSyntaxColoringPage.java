...
public final class SilverStripeSyntaxColoringPage extends AbstractSyntaxColoringPage implements IWorkbenchPreferencePage {
    ...
    protected Control createContents(final Composite parent) {
        ...
        link.setText("Note that the SilverStripe editor shares styles with the HTML Editor, see the <a>HTML: Syntax Coloring</a> preference page.");
        link.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                PreferencesUtil.createPreferenceDialogOn(parent.getShell(), "org.eclipse.wst.html.ui.preferences.styles", null, null);
            }
        });
        ...
        fDocument = StructuredModelManager.getModelManager().createStructuredDocumentFor("ca.edchipman.silverstripepdt.SilverStripeTemplateSource");
    ...
    private Collection getStylePreferenceKeys() {
        if (fStylePreferenceKeys == null) {
            ...
            styles.add(IStyleConstantsSS.SS_DELIM);
            styles.add(IStyleConstantsSS.SS_END_IF);
            styles.add(IStyleConstantsSS.SS_ELSE);
            styles.add(IStyleConstantsSS.SS_CONDITIONAL_OPEN);
            styles.add(IStyleConstantsSS.SS_CONDITIONAL_TEXT);
            styles.add(IStyleConstantsSS.SS_BASE_TAG);
            styles.add(IStyleConstantsSS.SS_COMMENT_DELIM);
            styles.add(IStyleConstantsSS.SS_COMMENT_TEXT);
            styles.add(IStyleConstantsSS.SS_VARIABLE);
            styles.add(IStyleConstantsSS.SS_REQUIREMENT_OPEN);
            styles.add(IStyleConstantsSS.SS_REQUIREMENT_CONTENT);
            styles.add(IStyleConstantsSS.SS_CONTROL_OPEN);
            styles.add(IStyleConstantsSS.SS_CONTROL_CONTENT);
    ...
    private void initRegionContextToStyleMap() {
        fContextToStyleMap.put(SilverStripeRegionContext.SS_OPEN, IStyleConstantsSS.SS_DELIM);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_CLOSE, IStyleConstantsSS.SS_DELIM);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_END_IF, IStyleConstantsSS.SS_END_IF);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_ELSE, IStyleConstantsSS.SS_ELSE);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_CONDITIONAL_OPEN, IStyleConstantsSS.SS_CONDITIONAL_OPEN);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_CONDITIONAL_TEXT, IStyleConstantsSS.SS_CONDITIONAL_TEXT);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_BASE_TAG, IStyleConstantsSS.SS_BASE_TAG);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_COMMENT_OPEN, IStyleConstantsSS.SS_COMMENT_DELIM);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_COMMENT_TEXT, IStyleConstantsSS.SS_COMMENT_TEXT);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_COMMENT_CLOSE, IStyleConstantsSS.SS_COMMENT_DELIM);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_VARIABLE, IStyleConstantsSS.SS_VARIABLE);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_REQUIREMENT_OPEN, IStyleConstantsSS.SS_REQUIREMENT_OPEN);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_REQUIREMENT_CONTENT, IStyleConstantsSS.SS_REQUIREMENT_CONTENT);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_CONTROL_OPEN, IStyleConstantsSS.SS_CONTROL_OPEN);
        fContextToStyleMap.put(SilverStripeRegionContext.SS_CONTROL_CONTENT, IStyleConstantsSS.SS_CONTROL_CONTENT);
    ...
    private void initStyleToDescriptionMap() {
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_DELIM, "SilverStripe Delimiters");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_END_IF, "End If");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_ELSE, "Else");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_CONDITIONAL_OPEN, "If Statement");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_CONDITIONAL_TEXT, "If Statement Content");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_BASE_TAG, "Base Tag");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_COMMENT_DELIM, "Comment Delimiters");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_COMMENT_TEXT, "Comment Text");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_VARIABLE, "Variable");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_REQUIREMENT_OPEN, "Requirement");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_REQUIREMENT_CONTENT, "Requirement Content");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_INCLUDE_OPEN, "Include");
        fStyleToDescriptionMap.put(IStyleConstantsSS.SS_INCLUDE_CONTENT, "Include Content");
